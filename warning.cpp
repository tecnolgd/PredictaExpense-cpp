...
{  
    ...
    double predict_save = bud-(avg_save*30.5); //prediction logic
    std::cout<<"____________________________"<<std::endl;
    if(predict_save<0.0){
        std::cout<<"Warning : You are overspending ! Projectect to overshoot the budget by "<<predict_save<< "this month"<<std::endl;
    }
    else{
